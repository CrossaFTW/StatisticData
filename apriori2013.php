...
//Produktivitas
$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Produktivitas='Tinggi'";
$result = mysql_query($sql);
$row = mysql_fetch_array($result);
	$PTinggi = $row[0];


$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Produktivitas='Cukup'";
$result = mysql_query($sql);
$row = mysql_fetch_array($result);
	$PCukup = $row[0];


$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Produktivitas='Rendah'";
$result = mysql_query($sql);
$row = mysql_fetch_array($result);
	$PRendah = $row[0];
...
//Nilai_TT
$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Nilai_TT= 'Tinggi'";
$result = mysql_query($sql);
$row = mysql_fetch_array($result);
	$TTinggi = $row[0];

$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Nilai_TT = 'Cukup'";
$result = mysql_query($sql);
$row = mysql_fetch_array($result);
	$TCukup = $row[0];

$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Nilai_TT='Rendah'";
$result = mysql_query($sql);
$row = mysql_fetch_array($result);
	$TRendah = $row[0];
...
if($PRendah>14){
	if($TRendah>14){
		$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Nilai_TT ='Rendah' && Produktivitas='Rendah'";
		$result = mysql_query($sql);
		$row = mysql_fetch_array($result);
	...
	if($TCukup>14){
		$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Nilai_TT ='Cukup' && Produktivitas='Rendah'";
		$result = mysql_query($sql);
		$row = mysql_fetch_array($result);
		$PTRendahCukup = $row[0];
	}else{
	...
	if($TTinggi>14){
		$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Nilai_TT ='Tinggi' && Produktivitas='Rendah'";
		$result = mysql_query($sql);
		$row = mysql_fetch_array($result);
...
if($PTinggi>14){
	if($TRendah>14){
		$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Nilai_TT ='Rendah' && Produktivitas='Tinggi' ";
		$result = mysql_query($sql);
		$row = mysql_fetch_array($result);
	...
	if($TCukup>14){
		$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Nilai_TT ='Cukup' && Produktivitas='Tinggi' ";
		$result = mysql_query($sql);
		$row = mysql_fetch_array($result);
		$PTTinggiCukup = $row[0];
	}else{
	...
	if($TTinggi>14){
		$sql = "SELECT COUNT( * ) FROM apriori2013 WHERE Nilai_TT ='Tinggi' && Produktivitas='Tinggi' ";
		$result = mysql_query($sql);
		$row = mysql_fetch_array($result);
